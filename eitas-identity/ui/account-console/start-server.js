...
const CLIENT_ID =
  process.env.EITAS_ACCOUNT_DEV_CLIENT_ID;

const CLIENT_SECRET =
  process.env.EITAS_ACCOUNT_DEV_CLIENT_SECRET;
...
if (
  ...
  throw new Error(
    "Les identifiants de développement doivent "
    + "être fournis par les variables d’environnement.",
  );
}

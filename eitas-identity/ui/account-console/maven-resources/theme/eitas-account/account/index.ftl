...
<html lang="${locale}">
  <head>
    ...
    <meta name="description" content="${properties.description!'Espace sécurisé de gestion de votre identité professionnelle.'}">
    <title>${properties.title!'EITAS Identity'}</title>
    <style>
      body {
        margin: 0;
      }
    ...
    <div id="app">
      <main class="container">
        <div class="keycloak__loading-container">
          ...
          <div>
            <p id="loading-text">Chargement de votre espace EITAS</p>
          </div>
        </div>
      </main>
    </div>
    <noscript>JavaScript doit être activé pour utiliser votre espace EITAS.</noscript>
